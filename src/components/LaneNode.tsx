    ...
    >
      <div className="flex flex-col gap-4">
        <p className="text-sm text-slate-600">
          Voulez-vous vraiment supprimer la branche <strong>"{data.name}"</strong> et tous ses commits ? Cette action est irréversible.
        </p>
        ...
        <div className="flex flex-col items-center relative pointer-events-none" style={{ width: 40, height: data.width }}>
          ...
          >
            <div
              ...
              style={{ color: '#334155' }}
            >
              <div className="lane-label flex items-center gap-2 cursor-pointer transition-opacity">
